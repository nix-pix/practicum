package ru.yandex.practicum.codingpractice.examcalc;
...
class Practicum {
    ...
    public static void main(String[] args) {
        ...
        if (currentTime.isBefore(examStart.minusMillis(ONE_DAY_MILLIS))) {
        ...
        Instant timeToGoToSleep = timeToWakeUp.minusMillis(sleepGoalHours * ONE_HOUR_MILLIS);
    ...
    private static double calculateDuration(Instant firstMoment, Instant secondMoment, TimeUnits unit) {
        switch (unit) {
            ...
            case DAYS: {
                return (double) (firstMoment.toEpochMilli() - secondMoment.toEpochMilli()) / ONE_DAY_MILLIS;
            }
            default:
                return 0;
        }
