package ru.yandex.practicum.codingpractice.recyclingcompany;

import java.util.*;

public class RecyclingCompany {
    // объявите поле для ссылки на карту (англ. map link)
    public static String link = "https://recyclemap.ru/";
    ...
    public static void main(String[] args) {
        ...
        switch (commandValue) {
            ...
            case "BONUS":
                ...
                System.out.println("Количество бонусных баллов: " + scores + ".");
        }
    }
