...
public class KeywordsGame {
    ...
    private static final int maxIncorrectAttempts = 5;
    ...
    public void runGame() {
        ...
        while (true) {
            ...
            if (incorrectAnswersCounter > maxIncorrectAttempts) {
                System.out.println("Количество неверных ответов больше " + maxIncorrectAttempts);
    ...
    private boolean writeReservedQuestion() {
        ...
        final int question = random.nextInt(reserved.size());
        System.out.println(reserved.get(question));
        return true;
    }
